    ...
    <div className="app">
      <header className="topbar">
        ...
        <div className="topbar-right">
          ...
          <AlertsBell deviceMap={deviceMap} />
      ...
      <div className="app-body">
        <nav className="side-nav">
          ...
          <button className={`side-nav-btn ${activeView === "dispositivos" ? "side-nav-active" : ""}`} onClick={() => setActiveView("dispositivos")} title="Dispositivos">
